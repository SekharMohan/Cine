...
public class UserPersonal {
    ...
    public String getRecent_projects ()
    {
        return recent_projects;
    }

    public void setRecent_projects (String recent_projects)
    {
    ...
    public void setWho_are_you (String who_are_you)
    {
    ...
    public String getCompleted_projects ()
    {
        return completed_projects;
    }

    public void setCompleted_projects (String completed_projects)
    {
