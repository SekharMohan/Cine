    ...
    import com.cine.views.widgets.CommentsAdapter;
    ...
    return  false;
            ...
            public void onShowPopup(View v, FeedModel.Commonwall_posts post,int postion){
    ...
    //        mDeviceHeight = size.y;
                ...
                popWindow.setBackgroundDrawable(getResources().getDrawable(R.drawable.edittext_bg));
